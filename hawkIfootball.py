...
import os
import time
from CricketMatch.CricketMatch import hic_main as hic
import cv2
import imutils
import pandas as pd
...
class GameStartPage(tk.Frame):
    def __init__(self, parent,controller):
        ...
        hic.get_metadata()
        meta_image = Image.open(PATH + "/CricketMatch/CricketMatch/position/positions.png").resize((WIDTH, HEIGHT))
...
class LiveViewPage(tk.Frame):
    def __init__(self, parent,controller):
        ...
        live_image = Image.open(PATH + "/CricketMatch/CricketMatch/resultImages/recent_picture.jpg").resize((WIDTH, HEIGHT))
...
class ScorePage(tk.Frame):
    def __init__(self, parent,controller):
        ...
        new.to_csv(PATH+"/CricketMatch/CricketMatch/scores/score_board.csv",mode='a', index=False,header=False)
        ##player to csv
        # time.sleep(3)
        self.remaining = 0
...
class LeaderBoardPage(tk.Frame):
    ...
    def __init__(self, parent,controller):
        ...
        df = pd.read_csv(PATH+'/CricketMatch/CricketMatch/scores/score_board.csv')
        print(df)
